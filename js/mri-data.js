...
const MRI_MATERIALS = [
...

  {
    id: 'bioflex',
    name: 'BioFlex®',
    full_name: 'BioFlex® Medical-Grade Polypropylene Random Copolymer (PP-R)',
    category: 'polymer',
    mri_condition: 'safe',
    mri_label: 'MR Safe',
    astm_class: 'MR Safe',
    ...
    sar_limit: null,
    notes: 'BioFlex® is a proprietary medical-grade polymer (polypropylene random copolymer, PP-R) manufactured by Poli International. Non-ferromagnetic, non-conductive, generates no RF heating and no MRI artifact. ISO 10993-6 tested and USP Class VI rated for biocompatibility.',
    clinical_note: 'Commonly used as a retainer for imaging because the material is non-metallic and non-conductive. Whether it stays in is decided by the radiographer and the MRI safety staff at the scan site, not here and not in advance. Tell them what it is and let them decide.',
    also_known_as: ['BioFlex retainer', 'polymer retainer', 'plastic piercing retainer', 'PP-R body jewelry'],
